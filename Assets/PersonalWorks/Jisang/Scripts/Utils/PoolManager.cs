...
namespace JJS.Utils
{
    ...
    public class PoolManager : MonoSingleton<PoolManager>
    {
        ...
        private bool containsInstanceLookUp(in GameObject clone)
        {
        ...
        public static bool ContainsInstanceLookUp(in GameObject clone)
        {
            if (IsQuitting)
                return false;

            return Instance.containsInstanceLookUp(clone);
        }
        #endregion
    }
