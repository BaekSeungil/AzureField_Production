Shader "Hidden/Sky/VolumetricClouds"
{
    Properties
    {
        ...
        [HideInInspector] _AmbientColorTint("Ambient Color Tint", Color) = (0.5, 0.5, 0.5, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            */
                ...
                return half4(rayHit.inScattering.xyz +( _AmbientColorTint.rgb), rayHit.transmittance * _AmbientColorTint.a);
