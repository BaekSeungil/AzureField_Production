...
public class VolumetricCloudsURP : ScriptableRendererFeature
{
    ...
    [SerializeField] private ColorParameter ambientColor;
    ...
    public override void Create()
    {
        ...
        else
        {
            ...
            volumetricCloudsPass.ambientColor = ambientColor;
        }
    ...
    public class VolumetricCloudsPass : ScriptableRenderPass
    {
        ...
        private static readonly int ambientColorTint = Shader.PropertyToID("_AmbientColorTint");
        ...
        private void UpdateMaterialProperties(Camera camera)
        {
            ...
            cloudsMaterial.SetColor(ambientColorTint, ambientColor.value);
