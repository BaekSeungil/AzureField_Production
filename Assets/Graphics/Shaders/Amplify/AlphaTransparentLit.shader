...
Shader "AlphaLit"
{
	Properties
	{
		...
		[HDR][Header(EMISSION)]_EmissiveColor("Emissive Color", Color) = (0,0,0,0)
		[HDR][SingleLineTexture]_EmissiveColorMap("Emission Map", 2D) = "white" {}
		_EmissiveColorMapUVs("Emissive UVs", Vector) = (1,1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor348_g2 = temp_output_89_0_g2;
				float3 temp_output_337_0_g2 = (_EmissiveColor).rgb;
				float3 temp_output_350_0_g2 = ( temp_output_337_0_g2 * _EmissiveIntensity );
				float3 lerpResult347_g2 = lerp( BaseColor348_g2 , temp_output_350_0_g2 , (tex2D( _EmissiveColorMap, ( ( IN.ase_texcoord8.xy * (_EmissiveColorMapUVs).xy ) + (_EmissiveColorMapUVs).zw ) )).rgb);
				...
				float3 Emission = lerpResult347_g2;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * (tex2D( _MetallicGlossMap, temp_output_133_0_g2 )).rgb ).x;
				...
				float Alpha = ( MapBaseColorAlpha107_g2 * _Opacity );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 temp_output_133_0_g2 = ( ( IN.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g2 = tex2D( _MainTex, temp_output_133_0_g2 );
				float MapBaseColorAlpha107_g2 = tex2DNode21_g2.a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_337_0_g2 = (_EmissiveColor).rgb;
				float3 temp_output_350_0_g2 = ( temp_output_337_0_g2 * _EmissiveIntensity );
				float3 lerpResult347_g2 = lerp( BaseColor348_g2 , temp_output_350_0_g2 , (tex2D( _EmissiveColorMap, ( ( IN.ase_texcoord4.xy * (_EmissiveColorMapUVs).xy ) + (_EmissiveColorMapUVs).zw ) )).rgb);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 temp_output_133_0_g2 = ( ( IN.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g2 = tex2D( _MainTex, temp_output_133_0_g2 );
				float MapBaseColorAlpha107_g2 = tex2DNode21_g2.a;
				

				surfaceDescription.Alpha = ( MapBaseColorAlpha107_g2 * _Opacity );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;11;-335.8485,-39.84644;Inherit;False;Material Sample;0;;2;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;12;FLOAT3;1;FLOAT3;6;FLOAT3;372;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
Node;AmplifyShaderEditor.RangedFloatNode;12;-347.4227,318.5739;Inherit;False;Property;_Opacity;Opacity;35;1;[Header];Create;True;1;Opacity;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-2.387207,156.0356;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-272,400;Inherit;False;Property;_AlphaClipThreshold;AlphaClipThreshold;34;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;186,-33;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;AlphaLit;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;39;Workflow;1;638600123184764051;Surface;0;638606965818682353;  Refraction Model;0;0;  Blend;0;638606965787802624;Two Sided;1;638606965621399652;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
WireConnection;13;0;11;8
WireConnection;13;1;12;0
WireConnection;1;0;11;1
WireConnection;1;1;11;6
WireConnection;1;2;11;328
WireConnection;1;3;11;3
WireConnection;1;4;11;2
WireConnection;1;5;11;4
WireConnection;1;6;13;0
WireConnection;1;7;14;0
ASEEND*/
//CHKSM=4DA9779DF3DBEF875BEF216887037501B8B9092F