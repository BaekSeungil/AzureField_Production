...
Shader "Distant Lands/Cozy/URP/Stylized Fog (Desktop)"
{
	...
	SubShader
	{
		...
		Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Transparent" "Queue"="Transparent-5" "UniversalMaterialType"="Unlit" }
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float Alpha = ( temp_output_75_0_g82 * ( 1.0 - 0.0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( temp_output_75_0_g82 * ( 1.0 - 0.0 ) );
